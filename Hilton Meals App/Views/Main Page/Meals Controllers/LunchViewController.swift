...
class LunchViewController: UIViewController, GADBannerViewDelegate {
    ...
    @objc func speakVoice() {
        let utterance = AVSpeechUtterance(string: "Lunch is \(mealLabel.text ?? "")")
    ...
    func retrieveMessage()
    {
        ...
        mealsDatabase.observe(.childAdded) { (snapshot) in
            ...
            self.mealLabel.text = lunchValue
        }
    }
    func applyTheme() {
