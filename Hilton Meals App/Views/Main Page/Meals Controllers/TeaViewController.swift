...
class TeaViewController: UIViewController , GADBannerViewDelegate{
    ...
    @objc func speakVoice() {
        let utterance = AVSpeechUtterance(string: "Tea is \(mealLabel.text ?? "")")
